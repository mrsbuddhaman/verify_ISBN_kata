...
class ISBN_test < Minitest::Test
	...
	def test_to_remove_dashes_spaces
	  ...
	  assert_equal("0471958697", remove_dashes_spaces("0471958697"))
    end
	...
	def test_valid_isbn
	   ...
	   assert_equal(true, isbn_valid?("877195869x"))
	   assert_equal(false, isbn_valid?("877195869"))
	   ...
	   assert_equal(false, isbn_valid?("4m80470059029"))
   end
